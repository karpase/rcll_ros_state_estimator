...
def generate_constant_predicates(control_team):	
	preds = []
	...
	preds.append(Predicate("control",[control_team])) # todo: how do we know which team we are?
	return preds
...
def main():	
	...
	while not rospy.is_shutdown():
		preds = generate_constant_predicates(team)        
